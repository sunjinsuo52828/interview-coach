...
print(f'  [OK] Matched items: {len(gap.matched_items)}')
print(f'  [OK] Gap items: {len(gap.gap_items)}')
...
print(f'  [OK] First question: {question[:80]}...')
...
print('')
print('='*50)
print(f'[RESULT] Conversation turns: {state[\"conversation_turns\"]}')
